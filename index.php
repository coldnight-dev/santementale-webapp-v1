...
<body>
    ...
    <div class="container">
        ...
        <div id="buttonsContainer">
            <a href="#" id="outilsBtn" class="cta"><span class="material-icons">business_center</span><span class="text">Outils interactifs</span></a>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (!isInstalled && clientVersion === '1.web') {
                if (isAndroid) {
                    ...
                    installBanner.innerHTML = '<span class="material-icons banner-icon">apple</span> Ajouter à l\'écran d\'accueil pour accéder aux tests diagnostics';
                }
