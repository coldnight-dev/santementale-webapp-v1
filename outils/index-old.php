...
// Validation de la version si elle est fournie
...
<body>
    ...
    <div id="syncInfoPopup" class="popup">
        <div class="popup-content">
            ...
            <button class="close-btn" onclick="document.getElementById('syncInfoPopup').classList.add('show');">Compris !</button>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Si pas de version dans localStorage, vérifier GET['v']
            if (!clientVersion) {
                const urlVersion = '<?php echo htmlspecialchars($clientVersion ?? ''); ?>';
                if (urlVersion && urlVersion.match(/\A1\.[0-9]{1,2}|1\.web\z/)) {
            ...
            // Afficher la version sans modifier localStorage
