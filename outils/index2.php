...
<body>
    <a href="/v1/?v=<?php echo isset($_COOKIE['client_version']) ? $_COOKIE['client_version'] : '1.web'; ?>" class="back-btn"><i class="fas fa-arrow-left"></i></a>
    <div id="aboutPopup" class="popup">
        <div class="popup-content">
            <p>©2025 SanteMentale.org, tous droits réservés</p>
            <p>API : 0.dev</p>
            <p>App : <?php echo isset($_COOKIE['client_version']) ? $_COOKIE['client_version'] : '1.web'; ?></p>
    ...
    <div class="container">
        ...
        <div class="tools-list">
            <a href="routine-quotidienne.php" class="tool-item" id="routineTool">
            ...
            <a href="journal-des-emotions.php" class="tool-item" id="emotionTool">
            ...
            <a href="journal-de-gratitude.php" class="tool-item" id="gratitudeTool">
        ...
        <p style="margin-top: 2.5em; color: var(--footer-color); line-height: 1.8;">
            v<?php echo isset($_COOKIE['client_version']) ? $_COOKIE['client_version'] : '1.web'; ?> • Accès anticipé<br>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            welcomeMessage.innerHTML = `<svg class="pencil-icon" viewBox="0 0 24 24" fill="#161616" onclick="document.getElementById('usernamePopup').classList.add('show');"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>Bonjour, <span class="username" onclick="document.getElementById('usernamePopup').classList.add('show');">${username}</span>!`;
        ...
        window.saveUsername = function() {
            ...
            document.getElementById('welcomeMessage').innerHTML = `<span class="material-icons" style="font-size: 24px; color: #0d47a1;">task</span><svg class="pencil-icon" viewBox="0 0 24 24" fill="#161616" onclick="document.getElementById('usernamePopup').classList.add('show');"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>Bonjour, <span class="username" onclick="document.getElementById('usernamePopup').classList.add('show');">${newUsername}</span>!`;
