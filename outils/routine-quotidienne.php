...
<head>
    ...
    <style>
        ...
        .title-icon-container { margin-left: auto; position: relative; }
        ...
        .help-menu.show { display: block !important; }
        .help-item {
            padding: 12px 16px;
            cursor: pointer;
        ...
        .help-item .material-icons { font-size: 20px; color: #3B82F6; }
        .help-close {
            position: absolute;
            top: 10px;
            right: 10px;
...
<body>
    ...
    <!-- ====== NOUVEAU v0.10 : POPUP QUOI DE NEUF ====== -->
    <div id="whatsNewPopup" class="popup">
        <div class="popup-content whats-new-popup" style="text-align:left;background:linear-gradient(135deg,#1e3a8a 0%,#1e40af 100%);color:white;border:2px solid #3B82F6;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                <h2 style="font-size:24px;font-weight:bold;margin:0;">✨ Quoi de neuf ?</h2>
                <span class="material-icons" style="cursor:pointer;font-size:24px;" onclick="closePopup('whatsNewPopup')">close</span>
            </div>
            <div id="whatsNewContent"></div>
            <div style="display:flex;gap:10px;margin-top:20px;justify-content:flex-end;">
                <button class="close-btn" onclick="closePopup('whatsNewPopup')" style="background:#3f3f46;color:white;border:none;">Plus tard</button>
                <button class="close-btn" onclick="closePopup('whatsNewPopup');startTutorial();" style="background:#10B981;color:white;border:none;">Découvrir</button>
            </div>
        </div>
    </div>
    <!-- ====== NOUVEAU v0.10 : TUTORIEL ====== -->
    ...
    <!-- ====== NOUVEAU v0.10 : MENU AIDE ====== -->
    <div id="helpMenu" class="help-menu">
        <span class="help-close" onclick="toggleHelpMenu()">✕</span>
        <div class="help-item" onclick="startTutorial();toggleHelpMenu();">
            <span class="material-icons">school</span>
            <span>Relancer le tutoriel</span>
        </div>
        <div class="help-item" onclick="openPopup('whatsNewPopup');toggleHelpMenu();">
            <span class="material-icons">info</span>
            <span>Voir les nouveautés</span>
        </div>
        <div class="help-item" onclick="toggleHelpMenu();">
    ...
    <script>
        ...
        const TUTORIAL_STEPS = [
            ...
            },
            {
                target: '.title-icon-container',
                title: 'Besoin d\'aide ?',
                description: 'Cliquez sur le point d\'interrogation pour accéder au menu d\'aide. Vous pouvez relancer le tutoriel à tout moment !',
                anchor: 'bottom'
            }
        ];
        const WHATS_NEW = [
            { icon: '⭐', title: 'Système XP & Niveaux', desc: 'Progressez en complétant des tâches' },
            { icon: '🎯', title: 'Tutoriel Interactif', desc: 'Découvrez les nouvelles fonctionnalités' },
            { icon: '📊', title: 'Graphiques Stats', desc: 'Visualisez votre progression' },
        ...
        function showTutorialStep() {
            ...
            tooltipLeft = Math.max(10, Math.min(tooltipLeft, window.innerWidth - 310));
        ...
        function render() {
            ...
            h += '<h1 class="text-3xl font-bold title-genos">Routines</h1><div class="title-icon-container"><span class="material-symbols-outlined title-icon-animated" style="color:#3B82F6;font-size:32px;">routine</span>';
            h += '<button onclick="toggleHelpMenu()" style="background:none;border:none;cursor:pointer;"><span class="material-symbols-outlined" style="font-size:24px;color:#3B82F6;">help</span></button>';
            h += '</div></div></div>';
        ...
        document.addEventListener('DOMContentLoaded', () => {
            try {
                ...
                checkBadges();
                render();
                // ====== NOUVEAU v0.10 : AFFICHER POPUP QUOI DE NEUF ======
