...
function render() {
    ...
    if (state.view === 'today') {
        ...
        h += renderHistoryList(); // NOUVEAU v0.11
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        // NOUVEAU v0.11 : Afficher popup "Quoi de neuf" au premier lancement
...
function renderHistoryList() {
    ...
    if (sortedHistory.length === 0) {
        ...
        sortedHistory.forEach(day => {
            ...
            html += '<div class="history-day-item p-3 rounded-lg border border-zinc-800" style="background:' + bgColor + ';" onclick="showDayDetail(\'' + day.date + '\')">';
...
function openEditTask(routineId, taskId) {
    ...
    document.getElementById('editTaskDurationInput').value = task.duration;
// ========================================
// SUITE DU SCRIPT v0.11 - À COLLER APRÈS openEditTask()
// ========================================
