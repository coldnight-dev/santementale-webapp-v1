...
<body>
    ...
    <script>
        const MODULE_REVISION = 15; // Incrémenter à chaque modification du code
        ...
        function render() {
            ...
            h += '<button onclick="state.view=\'capture\';render();" class="py-4 px-3 font-semibold transition-all ' + (state.view==='capture'?'text-blue-400 border-b-2 border-blue-500':'text-zinc-500') + '"><i class="bi bi-bullseye" style="font-size:24px;"></i></button>';
            h += '<button onclick="state.view=\'stats\';render();" class="py-4 px-3 font-semibold transition-all ' + (state.view==='stats'?'text-blue-400 border-b-2 border-blue-500':'text-zinc-500') + '"><i class="bi bi-bar-chart-fill" style="font-size:24px;"></i></button>';
            h += '<button onclick="state.view=\'journal\';render();" class="py-4 px-3 font-semibold transition-all ' + (state.view==='journal'?'text-blue-400 border-b-2 border-blue-500':'text-zinc-500') + '"><i class="bi bi-journal-text" style="font-size:24px;"></i></button>';
            h += '<button onclick="state.view=\'calendar\';render();" class="py-4 px-3 font-semibold transition-all ' + (state.view==='calendar'?'text-blue-400 border-b-2 border-blue-500':'text-zinc-500') + '"><i class="bi bi-calendar-month" style="font-size:24px;"></i></button>';
            h += '<button onclick="state.view=\'goals\';render();" class="py-4 px-3 font-semibold transition-all ' + (state.view==='goals'?'text-blue-400 border-b-2 border-blue-500':'text-zinc-500') + '"><i class="bi bi-trophy" style="font-size:24px;"></i></button>';
