// routine-quotidienne.php v0.10 - JavaScript
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        // NOUVEAU v0.10 : Afficher popup "Quoi de neuf" au premier lancement
        if (state.lastSeenVersion !== MODULE_REVISION) {
            state.isFirstTimeView = true;
            setTimeout(() => {
                renderWhatsNew(false); // Pas de croix la première fois
                openPopup('whatsNewPopup');
            }, 1000);
        }
    } catch(e) {
