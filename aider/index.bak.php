...
<head>
    ...
    <style>
        :root {
            ...
            --gradient-pink: linear-gradient(135deg, #ffb3ba, #ff6b7a);
            --border-radius: 12px;
    ...
    <div class="container">
        ...
        <div class="content-box">
            ...
            <div class="action-buttons">
                ...
                <a href="freecash.php" target="_blank" rel="noopener noreferrer" class="icon-btn freecash" title="Soutenez-nous gratuitement">
